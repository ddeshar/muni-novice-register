...
<head>
    ...
    <style>
        :root {            /* Buddhist-Inspired Color Palette */
            --primary: #8B4513;          /* Saddle Brown - main brand color */
            --primary-dark: #654321;     /* Darker brown for hover states */
            --primary-light: #CD853F;    /* Peru - lighter brown for accents */
            --primary-gradient: linear-gradient(135deg, #8B4513, #654321); /* Primary gradient */
            --secondary: #DAA520;        /* Goldenrod - sacred gold color */
            --secondary-dark: #B8860B;   /* Dark goldenrod for hover */
            --secondary-light: #F0E68C;  /* Khaki - light gold for backgrounds */
            --accent: #FF8C00;          /* Dark orange - saffron robe color */
            --accent-light: #FFA500;    /* Orange for highlights */
            
            /* Neutral Colors */
            --background: #FFF8F0;      /* Warm off-white */
            --surface: #FFFFFF;         /* Pure white for cards */
            --surface-soft: #F8F4EE;    /* Soft warm background */
            --text-primary: #2D1810;    /* Dark brown for primary text */
            --text-secondary: #6B4423;  /* Medium brown for secondary text */
            --text-muted: #8B6F47;      /* Light brown for muted text */
            --border-light: #E0CDA9;      /* Light beige for borders */
            --border-dark: #C2B280;     /* Dark beige for hover states */

            /* Status Colors */
            --success: #4A5D23;         /* Dark olive green */
            --success-light: #8FBC8F;   /* Sage green */
            --warning: #B8860B;         /* Dark goldenrod */
            --warning-light: #F0E68C;   /* Light gold */
            --danger: #8B0000;          /* Dark red */
            --danger-light: #F4A0A0;    /* Light red */
        ...
        @media (max-width: 576px) {
            ...
            .form-control, .form-select {
                ...
                font-size: 1rem;
                min-height: 48px; /* Prevent iOS zoom */
                border-radius: var(--border-radius-small);
            }
